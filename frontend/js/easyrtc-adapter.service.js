(function(angular) {
  ...
  angular.module('hublin.easyrtc.connector')
    .factory('easyRTCAdapter', easyRTCAdapter);
  ...
  function easyRTCAdapter(
    ...
    easyRTCListenerFactory,
    EASYRTC_BITRATES,
    LOCAL_VIDEO_ID,
    REMOTE_VIDEO_IDS,
    EASYRTC_APPLICATION_NAME,
    EASYRTC_EVENTS,
    MAX_P2P_MESSAGE_LENGTH
  ) {
    ...
    var easyrtc = easyRTCFactory.get();
    ...
    var tmp = easyRTCListenerFactory(easyrtc.setDataChannelOpenListener, 'dataChannelOpenListener');
    var addDataChannelOpenListener = tmp.addListener;
    var removeDataChannelOpenListener = tmp.removeListener;

    tmp = (function() {
      var listener = easyRTCListenerFactory(easyrtc.setPeerListener, 'peerListener');
    ...
    var removePeerListener = tmp.removeListener;

    tmp = easyRTCListenerFactory(easyrtc.setDataChannelCloseListener, 'dataChanelCloseListener');
